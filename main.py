...
def start_training(character):
    ...
    class_descript = {'warrior': f'{character.name}, '
                                 'ты Воитель — великий мастер ближнего боя.',
                      'defence': f'{character.name}, '
                                 'ты Маг — превосходный укротитель стихий.',
                      'special': f'{character.name}, '
                                 'ты Лекарь — чародей, способный '
                                 'исцелять раны.'}
    ...
    print(f'{character.name} {class_descript[character]}')
    ...
    while cmd != 'skip':
        ...
        if cmd in commands:
            print(commands[cmd](character.name, character))
